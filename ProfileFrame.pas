...
type
  TFrame3 = class(TFrame)
    ...
    Label24: TLabel;
    Label25: TLabel;
    rewrite_check: TCheckBox;
    rewrite_global_check: TCheckBox;
    rewrite_template_box_1: TCheckListBox;
    RadioGroup3: TRadioGroup;
    rewrite_level_combox: TComboBox;
    rewrite_level_info: TRadioButton;
    rewrite_level_warn: TRadioButton;
    rewrite_level_error: TRadioButton;
    CheckBox8: TCheckBox;
    rewrite_custom_memo: TMemo;
    TabSheet86: TTabSheet;
    ScrollBox66: TScrollBox;
    Label20: TLabel;
    error_doc_checkbox: TCheckListBox;
    ComboBox1: TComboBox;
    Edit15: TEdit;
    Memo2: TMemo;
    Button19: TButton;
